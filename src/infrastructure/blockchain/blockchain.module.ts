...
const providers: Provider[] = [ChainClientFactory, ProtocolReadService, BlockchainRegistryService];

@Global()
@Module({
  imports: [AppConfigModule, DatabaseModule],
  providers,
  exports: [ChainClientFactory, ProtocolReadService, BlockchainRegistryService],
})
